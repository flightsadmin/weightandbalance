                        ...
                        <table class="table table-sm">
                            <tr>
                                ...
                                <td>{{ $flight->flight_number }}
                                    <span
                                        class="float-end badge bg-{{ $flight->status === 'cancelled' ? 'danger' : ($flight->status === 'arrived' ? 'success' : 'warning') }}">
                            ...
                            <tr>
                                <th>Aircraft</th>
                                <td>{{ $flight->aircraft->registration_number }} ({{ $flight->aircraft->type }})</td>
                            </tr>
                            <tr>
                                <th>Route</th>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button wire:click="calculateWeightBalance({{ $flight }})" class="btn btn-sm btn-primary">
