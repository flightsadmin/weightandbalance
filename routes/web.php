...
Route::get('airlines/create', App\Livewire\Airline\Form::class)->name('airlines.create');
Route::get('airlines/{airline}/edit', App\Livewire\Airline\Form::class)->name('airlines.edit');
